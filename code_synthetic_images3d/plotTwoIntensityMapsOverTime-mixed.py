...
def new_argument_parser(description = "Plot convolved intensity maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "twoIntensityMapsInTime",
                         help = 'save directory (default: twoIntensityMapsInTime)')
...
def make_plot(frames, show = False):
    ...
    plot.suptitle("[%s]\n%s" % (title1, title2), x = 0.55, y = 1.24, fontsize = fontsize + 3, bbox = dict(facecolor = 'none', edgecolor = 'black', linewidth = 1.5, pad = 7.0))
