...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "meridionalGasDensityMaps",
                         help = 'save directory (default: meridionalGasDensityMaps)')
...
def make_plot(frame, show = False):
    ...
    if center:
        normalized_density, shift_c = shift_density(normalized_density, fargo_par, reference_density = surface_density)
    ...
    # Save, Show, and Close
    if version is None:
        save_fn = "%s/meridionalGasDensityMap_%04d.png" % (save_directory, frame)
    else:
        save_fn = "%s/v%04d_meridionalGasDensityMap_%04d.png" % (save_directory, version, frame)
