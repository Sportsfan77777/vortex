...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "3DstackDustVerticalVelocityMaps",
                         help = 'save directory (default: 3DstackDustVerticalVelocityMaps)')
...
def make_plot(z_level, show = False):
    ...
    cbar.set_label(r"Dust Vertical Velocity (z = %d)" % z_level, fontsize = fontsize, rotation = 270, labelpad = 25)

    # Save, Show, and Close
    if version is None:
        save_fn = "%s/dustVerticalVelocityMap_%04d-z%04d.png" % (save_directory, frame, z_level)
    else:
        save_fn = "%s/v%04d_dustVerticalVelocityMap_%04d-z%04d.png" % (save_directory, version, frame, z_level)
