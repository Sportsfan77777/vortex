...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "manualDustScaleHeight",
                         help = 'save directory (default: manualDustScaleHeight)')
...
def make_plot(frame, show = False):
    ...
    for i in range(num_rad):
        peak = np.max(meridional_density[:, i])

        # Look for where density drops off by a factor of e
        drop_off = peak / np.e
