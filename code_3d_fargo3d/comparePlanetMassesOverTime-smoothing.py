...
colors = ["gold", "gold", "#17becf", "#17becf", "b", "b"]
#labels = [r"2-D $256 \times 256$", r"3-D $256 \times 256$", r"2-D $512 \times 512$", r"3-D $512 \times 512$"]
labels = [r"2-D  $R_\mathrm{s} = 0.1 R_\mathrm{H}$", r"3-D  $R_\mathrm{s} = 0.1 R_\mathrm{H}$", \
          r"2-D  $R_\mathrm{s} = 0.3 R_\mathrm{H}$", r"3-D  $R_\mathrm{s} = 0.3 R_\mathrm{H}$", \
          r"2-D  $R_\mathrm{s} = 0.6 R_\mathrm{H}$", r"3-D  $R_\mathrm{s} = 0.6 R_\mathrm{H}$"]
linestyles = ['-', "--"]
