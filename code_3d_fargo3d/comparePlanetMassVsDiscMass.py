...
def make_plot():
    ...
    # Data
    for i, (directories, disc_masses_i, final_masses_i) in enumerate(zip(master_directories, disc_masses, final_masses)):
    ...
    plot.savefig("planet_mass_disc_mass_comparison-3D.pdf", bbox_inches = "tight", format = "pdf")
    plot.show()
