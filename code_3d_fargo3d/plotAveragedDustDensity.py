...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "averagedDustDensity",
...
def make_plot(frame, show = False):
    ...
    normalized_density = averagedDensity / dust_surface_density_zero
    ...
    # Save, Show, and Close
    if version is None:
        save_fn = "%s/averagedDustDensity_%04d.png" % (save_directory, frame)
    else:
        save_fn = "%s/v%04d_averagedDustDensity_%04d.png" % (save_directory, version, frame)
