...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    parser.add_argument('-r', dest = "selected_radius", type = float, default = 1.4,
                         help = 'radius at which to take the cut (default: 1.4)')

    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "radialCutGasDensityMaps",
                         help = 'save directory (default: radialCutGasDensityMaps)')
...
def make_plot(frame, show = False):
    ...
    plot.ylabel(r"$\theta$ [degrees]", fontsize = fontsize)
