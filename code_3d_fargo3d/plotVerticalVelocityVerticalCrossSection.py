...
def make_plot(frame, show = False):
    ...
    plot.ylabel(r"$z [$h$]$", fontsize = fontsize)
    ...
    # Save, Show, and Close
    if version is None:
        save_fn = "%s/verticalVerticalVelocityMap_%04d.png" % (save_directory, frame)
    else:
        save_fn = "%s/v%04d_verticalVerticalVelocityMap_%04d.png" % (save_directory, version, frame)
