...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "verticalAlphaProfile",
                         help = 'save directory (default: verticalAlphaProfile)')
...
def make_plot(frame, show = False):
    ...
    r_start_i = np.searchsorted(rad, r_start)
    ...
    # Save, Show, and Close
    if version is None:
        save_fn = "%s/verticalAlphaProfile_%04d.png" % (save_directory, frame)
    else:
        save_fn = "%s/v%04d_verticalAlphaProfile_%04d.png" % (save_directory, version, frame)
