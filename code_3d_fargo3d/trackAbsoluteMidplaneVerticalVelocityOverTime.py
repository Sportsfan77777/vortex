...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "absoluteMidplaneVerticalVelocityMapsOverTime",
                         help = 'save directory (default: absoluteMidplaneVerticalVelocityMapsOverTime)')
...
def make_plot(show = False):
    ...
    if version is None:
        save_fn = "%s/%s_absoluteVerticalVelocityMap_%04d_%04d_%04d.png" % (save_directory, directory_name, args.frames[0], args.frames[1], args.frames[2])
    else:
        save_fn = "%s/v%04d_%s_absoluteVerticalVelocityMap_%04d_%04d_%04d.png" % (save_directory, version, directory_name, args.frames[0], args.frames[1], args.frames[2])
