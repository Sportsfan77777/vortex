...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "3DstackGasDensityMaps",
...
def make_plot(z_level, show = False):
    ...
    cbar.set_label(r"Gas Density  $\rho$ $/$ $\rho_0$", fontsize = fontsize, rotation = 270, labelpad = 25)

    # Save, Show, and Close
    if version is None:
        save_fn = "%s/densityMap_%04d-z%04d.png" % (save_directory, frame, z_level)
    else:
        save_fn = "%s/v%04d_densityMap_%04d-z%04d.png" % (save_directory, version, frame, z_level)
