...
file_prefixes = ["h06_nu7_a40_s5787-K60-3D-med_res", "h06_nu7_a40_s5787-K60-3D", "h06_nu7_a40_s5787-K60-2D-med_res", "h06_nu7_a40_s5787-K60-2D"]
...
colors = ["darkorange", "gold", "#17becf", "b"]
#labels = [r"2-D $256 \times 256$", r"3-D $256 \times 256$", r"2-D $512 \times 512$", r"3-D $512 \times 512$"]
labels = [r"3-D  $512 \times 512$", r"3-D  $256 \times 256$", r"2-D  $512 \times 512$", r"2-D  $256 \times 256$"]
linewidths = [linewidth + 1, linewidth - 1]
...
def make_plot(show = False):
    ...
    for i, prefix in enumerate(file_prefixes):
        ...
        result = plot.plot(x, y, c = colors[i], linewidth = linewidths[i % 2], zorder = 99, label = labels[i], alpha = alpha)
