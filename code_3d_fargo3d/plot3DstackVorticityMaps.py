...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "3DstackVorticityMaps",
...
def make_plot(z_level, show = False):
    ...
    title2 = r"$t = %d$ $\mathrm{orbits}}$  $z = %d$  [$m_\mathrm{p}(t)\ =\ %.2f$ $M_\mathrm{Jup}$]" % (orbit, z_level, current_mass)
    ...
    # Save, Show, and Close
    if version is None:
        save_fn = "%s/vorticityMap_%04d-z%04d.png" % (save_directory, frame, z_level)
    else:
        save_fn = "%s/v%04d_vorticityMap_%04d-z%04d.png" % (save_directory, version, frame, z_level)
