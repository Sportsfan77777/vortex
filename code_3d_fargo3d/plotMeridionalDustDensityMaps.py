...
def make_plot(frame, show = False):
    ...
    plot.text(x_mid, y_text * (plot.ylim()[-1] - plot.ylim()[-1]), title1, horizontalalignment = 'center', bbox = dict(facecolor = 'none', edgecolor = 'black', linewidth = 1.5, pad = 7.0), fontsize = fontsize + 2)
