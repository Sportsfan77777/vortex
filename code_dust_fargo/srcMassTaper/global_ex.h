...
extern int TimeStep;
extern real SOUNDSPEED[MAX1D], DSOUNDSPEED[MAX1D];
extern real GLOBAL_SOUNDSPEED[MAX1D], DGLOBAL_SOUNDSPEED[MAX1D];
extern boolean Merge, AdvecteLabel, FakeSequential, MonitorIntegral, debug, OnlyInit, DustDiff, GasDcouple, DustImp;
extern boolean	GotoNextOutput, StoreSigma, ViscosityAlpha, DViscosityAlpha, RocheSmoothing;
...
extern PolarGrid *RhoStar, *RhoInt, *Potential, *DRhoStar, *DRhoInt, *TStop, *Diag1, *Diag2, *Diag3, *Fdiffrp, *Fdifftp;
