...
def make_plot(frame, show = False):
    ...
    plot.text(-0.84 * x_range, 1.15 * plot.ylim()[-1], text_mass, fontsize = fontsize, color = 'black', horizontalalignment = 'right')
    plot.text(0.84 * x_range, 1.15 * plot.ylim()[-1], text_visc, fontsize = fontsize, color = 'black', horizontalalignment = 'left')
