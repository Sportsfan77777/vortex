...
def new_argument_parser(description = "Plot dust density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "azimuthalPressureGradientMaps",
                         help = 'save directory (default: azimuthalPressureGradientMaps)')
...
def make_plot(frame, show = False):
    ...
    # Save, Show, and Close
    if version is None:
        save_fn = "%s/azimuthalPressureGradientMap_%04d.png" % (save_directory, frame)
    else:
        save_fn = "%s/v%04d_azimuthalPressureGradientMap_%04d.png" % (save_directory, version, frame)
