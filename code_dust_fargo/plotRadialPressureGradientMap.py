...
def new_argument_parser(description = "Plot dust density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "radialPressureGradientMaps",
                         help = 'save directory (default: radialPressureGradientMaps)')
...
def make_plot(frame, show = False):
    ...
    # Save, Show, and Close
    if version is None:
        save_fn = "%s/radialPressureGradientMap_%04d.png" % (save_directory, frame)
    else:
        save_fn = "%s/v%04d_radialPressureGradientMap_%04d.png" % (save_directory, version, frame)
