"""
plot azimuthally averaged stopping time (mean and median)

Usage:
python plotAveragedStoppingTime.py frame_number <== plot one frame
python plotAveragedStoppingTime.py -1 <<<===== Plots a sample
"""
...
def make_plot(frame, show = False):
    ...
    def choose_axis(i, axis):
        ...
        plot.title("%s\n" % (this_title) + r"$t = %d$ $\rm{orbits}:$" % (orbit), fontsize = fontsize + 1)
