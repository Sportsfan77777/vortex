...
InitVariables()
{
  ...
  var("KLEYFACC1", &KLEYFACC1, REAL, NO, "0.33333");
  var("KLEYFACC2", &KLEYFACC2, REAL, NO, "0.66667");
  var("KLEYFRAC1", &KLEYFRAC1, REAL, NO, "0.75");
  var("KLEYFRAC2", &KLEYFRAC2, REAL, NO, "0.45");
  var("INCLUDEACCRETIONP", INCLUDEACCRETIONP, STRING, NO, "NO");
}
