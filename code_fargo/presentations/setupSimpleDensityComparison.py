...
### Labels ###
case1_label = r"$1$ $M_J$, $\alpha_{visc} = 3 \times 10^{-4}$"
case2_label = r"$1$ $M_J$, $\alpha_{visc} = 3 \times 10^{-5}$"
case3_label = r"$5$ $M_J$, $\alpha_{visc} = 3 \times 10^{-4}$"
case4_label = r"$5$ $M_J$, $\alpha_{visc} = 3 \times 10^{-5}$"
...
#plot.plot([line5_50, line5_50], [vertical_min_value, vertical_max_value], c = "k", alpha = vertical_alpha, linewidth = vertical_linewidth, dashes = style5)
#plot.plot([line5_30, line5_30], [vertical_min_value, vertical_max_value], c = "k", alpha = vertical_alpha, linewidth = vertical_linewidth, dashes = style5)
#plot.plot([line5_20, line5_20], [vertical_min_value, vertical_max_value], c = "k", alpha = vertical_alpha, linewidth = vertical_linewidth, dashes = style5)
#plot.plot([line5_15, line5_15], [vertical_min_value, vertical_max_value], c = "k", alpha = vertical_alpha, linewidth = vertical_linewidth, dashes = style5)
#plot.plot([line5_10, line5_10], [vertical_min_value, vertical_max_value], c = "k", alpha = vertical_alpha, linewidth = vertical_linewidth, dashes = style5)

## Labels ##
# 10^-4
#text_y4 = max_value + 0.02
...
#plot.text(midpoint4, text_y4 + 0.3, r"$\dot{M}$ = $10^{-4}$ $M_J$ / yr" + "\nat 20, 10, and 5 AU", horizontalalignment = 'center')
...
brace5_x, brace5_y = range_brace(line5_50, line5_10, height = 0.15)
...
plot.plot(case4_x, case4_y, marker = "s", c = colors[4], markersize = markersize, linewidth = linewidth, label = case4_label) # M5, v7
plot.plot(case3_x, case3_y, marker = "p", c = colors[3], markersize = markersize + 1, linewidth = linewidth, label = case3_label) # M5, v6
plot.plot(case2_x, case2_y, marker = "*", c = colors[2], markersize = markersize + 3, linewidth = linewidth, label = case2_label) # M1, v7
plot.plot(case1_x, case1_y, marker = "^", c = colors[1], markersize = markersize, linewidth = linewidth, label = case1_label) # M1, v6
...
# Save + Close
plot.savefig("simple_density_comparison.png", bbox_inches = "tight")
plot.savefig("simple_density_comparison.pdf", bbox_inches = "tight", format = "pdf")
plot.show()