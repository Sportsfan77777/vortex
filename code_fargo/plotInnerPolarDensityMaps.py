...
python plotInnerPolarDensityMaps.py
python plotInnerPolarDensityMaps.py frame_number
python plotInnerPolarDensityMaps.py -1 <<<===== Plots a sample
python plotInnerPolarDensityMaps.py -m
"""
...
save_directory = "innerPolarGasDensityMaps"
