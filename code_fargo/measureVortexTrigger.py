...
def find_slope(averagedDensity, start_rad, end_rad):
    ...
    try:
        ...
        sigma = 2 * scale_height / (rad[1] - rad[0]) # 2 scale heights of points
...
def getWeightedDerivative(frame):
    ...
    return weighted_mean_derivative
...
gap_structures = {}
for frame in frames:
    gap_structure = getWeightedDerivative(frame)
    gap_structures[frame] = gap_structure

## Store Data ##
pickle.dump(gap_structures, open("gap_structures.p", "wb"))
