...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "gasDensityMapComaprisons",
                         help = 'save directory (default: gasDensityMapComaprisons)')
...
def make_plot(frame, show = False):
    ...
    if center:
        if taper_time < 10.1:
            ...
            pass
            # shift away from the minimum
        density1 = np.roll(density1, shift_c)
        density2 = np.roll(density2, shift_c)
    normalized_density1 = density1 / surface_density_zero
    normalized_density2 = density2 / surface_density_zero
    ...
    if use_contours:
        ...
        plot.contour(x, y, np.transpose(normalized_density2), levels = levels, origin = 'upper', linewidths = 1, colors = colors)
