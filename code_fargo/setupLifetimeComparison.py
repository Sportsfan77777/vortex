...
plot.text(midpoint4, 1.29**2 * text_y4, r"$\dot{M}$ = $10^{-4}$ $M_J$" + "\nat 20, 10, and 5 AU", horizontalalignment = 'center')
...
plot.text(midpoint5, 1.27**2 * text_y5, r"$\dot{M}$ = $10^{-5}$ $M_J$ at 20 and 10 AU", horizontalalignment = 'center')
...
brace5_x, brace5_y = range_brace(line5_20, line5_10, height = 10000)
...
# Save + Close
plot.savefig("lifetime_comparison.png", bbox_inches = "tight")
plot.savefig("lifetime_comparison.pdf", bbox_inches = "tight", format = "pdf")
plot.show()