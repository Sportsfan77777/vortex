...
python plotPolarDensityMaps.py
python plotPolarDensityMaps.py frame_number
python plotPolarDensityMaps.py -1 <<<===== Plots a sample
python plotPolarDensityMaps.py -m
"""
