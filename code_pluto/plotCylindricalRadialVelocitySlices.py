...
save_directory = "cylindricalRadialVelocitySlices"
...
def make_plot(frame, show = False):
    ...
    plot.title("Cylindrical Radial Velocity Slice (%s = %s) at Orbit %d" % (slice_choice, this_slice, orbit), fontsize = fontsize + 1)

    # Save and Close
    plot.savefig("%s/%s_cylindricalRadialVelocitySlice_%s%04d.png" % (save_directory, o.prefix, suffix, frame), bbox_inches = 'tight', dpi = my_dpi)
    if show:
        plot.show()
