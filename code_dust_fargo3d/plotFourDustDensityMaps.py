...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "fourDustDensityMaps%d",
                         help = 'save directory (default: fourDustDensityMaps%d)')
...
def make_plot(frames, show = False):
    ...
    def add_to_plot(i):
        ...
        cbar.set_label(r"Dust Surface Density  $\Sigma_\mathrm{d}$ $/$ $\Sigma_\mathrm{d,0}$", fontsize = fontsize, rotation = 270, labelpad = 25)
    ...
    # Save, Show, and Close
    if version is None:
        save_fn = "%s/dustDensityMap_%04d-%04d-%04d-%04d.png" % (save_directory, frames[0], frames[1], frames[2], frames[3])
    else:
        save_fn = "%s/v%04d_dustDensityMap_%04d-%04d-%04d-%04d.png" % (save_directory, version, frames[0], frames[1], frames[2], frames[3])
