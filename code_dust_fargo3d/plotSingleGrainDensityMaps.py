...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "single-grainDensityMaps",
                         help = 'save directory (default: single-grainDensityMaps)')
...
def make_plot(frame, show = False):
    ...
    def add_to_plot(i, grain):
        ...
        if i == 0:
           ...
           cbar = fig.colorbar(result); result.set_clim(0, cmax)
