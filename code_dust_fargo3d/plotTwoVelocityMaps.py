...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "twoVelocityMaps",
                         help = 'save directory (default: twoVelocityMaps)')
...
def make_plot(frames, show = False):
    ...
    def add_rad_to_plot(i):
        ...
        plot.title("%s" % (title), y = 1.06, fontsize = fontsize + 1)
