...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    parser.add_argument('--compare', dest = "compare", nargs = '+', default = ["../h05_nu9_b3-M03-768x768-case4-stockholm-migrating-backup-2", "../h05_nu9_b3-M03-768x768-case4-stockholm-migrating-no-extra-gap-torque-simple-mass-loss", "../h05_nu9_b3-M03-768x768-case12-stockholm-migrating-copy"],
    ...
    parser.add_argument('--range', dest = "r_lim", type = float, nargs = 2, default = [0, 3000],
...
def make_plot(show = False):
    ...
    if args.compare is not None:
        ...
        plot.legend(loc = "upper right", fontsize = fontsize - 5, handles = handles_r, labels = labels_r, facecolor = "white", framealpha= 0.5)
