...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    parser.add_argument('--compare', dest = "compare", nargs = '+', default = ["../h10_nu9_b45-Mt3-768x768-case12-stockholm"],
...
def make_plot(frame, show = False):
    ...
    result,  = plot.plot(x, y, linewidth = linewidth, c = "b", zorder = 199, label = "MH25 (Four-comp.)")
    ...
    if args.compare is not None:
        ...
        for i, directory in enumerate(directories):
            ...
            result = plot.plot(x, y_compare, c = "r", linewidth = linewidth, alpha = 0.6, zorder = 99, label = labels[i])
    ...
    if version is None:
        ...
        save_fn = "%s/v%04d_timeAveragedGapProfile_%04d.pdf" % (save_directory, version, frame)
