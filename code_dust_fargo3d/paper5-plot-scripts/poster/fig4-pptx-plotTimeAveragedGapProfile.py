...
def make_plot(frame, show = False):
    ...
    result,  = plot.plot(x, y, linewidth = linewidth, c = "b", zorder = 199, label = "MH25")
    ...
    if args.compare is not None:
        ...
        for i, directory in enumerate(directories):
            ...
            result = plot.plot(x, y_compare, c = "blueviolet", linewidth = linewidth, alpha = 0.6, zorder = 99, label = labels[i])
