...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    parser.add_argument('-r', dest = "ref", type = int, default = 3,
...
def make_plot(frame, show = False):
    ...
    text_comps = "(This work)"
    #text_comps2 = "& Extra Gap Torque)"
    plot.text(0.95 * x_range + x_min, 0.90 * plot.ylim()[-1], text_comp, fontsize = fontsize, color = 'black', horizontalalignment = 'right')
    ...
    if version is None:
        ...
        save_fn = "%s/v%04d_timeAveragedGapProfile_%s_%s.pdf" % (save_directory, version, directory_name, frame_string)
