...
def make_plot(show = False):
    ...
    plot.legend(loc = "upper left", fontsize = fontsize - 3)
    ...
    plot.ylabel(r"$\Sigma_\mathrm{p}$ $/$ $\Sigma_\mathrm{gap}$", fontsize = fontsize)
    ...
    if version is None:
        ...
        save_fn = "%s/v%04d_%s_gapDepthOverTime.pdf" % (save_directory, version, directory_name)
