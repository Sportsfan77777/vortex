...
def make_plot(frame, show = False):
    ...
    plot.text(0.95 * x_range + x_min, 0.2 * plot.ylim()[-1], text_comp, fontsize = fontsize, color = 'black', horizontalalignment = 'right')
    plot.text(0.95 * x_range + x_min, 0.15 * plot.ylim()[-1], text_comps, fontsize = fontsize - 6, color = 'black', horizontalalignment = 'right')
