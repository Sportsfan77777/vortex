...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    parser.add_argument('--compare', dest = "compare", nargs = '+', default = ["/tiara/home/mhammer/scratch/h10_nu5_b45-Mt3-768x768-case4-stockholm-no-extra-gap-torque"],
...
def make_plot(frame, show = False):
    ...
    if args.compare is not None:
        ...
        for i, directory in enumerate(directories):
            ...
            result = plot.plot(x, y_compare, c = "blueviolet", linewidth = linewidth, alpha = 0.9, zorder = 99, label = "Three-component")
    ...
    text_comps2 = "w/ & w/o Extra Gap Torque"
    plot.text(0.95 * x_range + x_min, 0.78 * plot.ylim()[-1], text_comp, fontsize = fontsize, color = 'black', horizontalalignment = 'right')
    plot.text(0.95 * x_range + x_min, 0.92 * plot.ylim()[-1], text_comps, fontsize = fontsize - 6, color = 'black', horizontalalignment = 'right')
    plot.text(0.95 * x_range + x_min, 0.86 * plot.ylim()[-1], text_comps2, fontsize = fontsize - 6, color = 'black', horizontalalignment = 'right')
