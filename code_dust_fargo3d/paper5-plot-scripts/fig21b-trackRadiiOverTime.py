...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    parser.add_argument('--compare', dest = "compare", nargs = '+', default = ["../h10_nu9_b45-Mt3-768x768-case12-stockholm-migrating", "../h10_nu9_b0-Mt3-768x768-case4-stockholm-migrating"],
...
def make_plot(show = False):
    ...
    x = times
    y = planet_radii
    result = plot.plot(x, y, c = "C1", linewidth = linewidth + 1, zorder = 199, label = "Full Model (No Viscosity)")
