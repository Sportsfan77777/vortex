...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    parser.add_argument('--compare', dest = "compare", nargs = '+', default = ["../h05_nu5_b0-Mt5-768x768-case4-stockholm", "../h05_nu9_b45-Mt5-768x768-case4-stockholm", "../h05_nu9_b0-Mt5-768x768-case4-stockholm"],
