...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    parser.add_argument('--compare', dest = "compare", nargs = '+', default = ["../h10_nu5_b45-Mt3-768x768-case4-stockholm-MHDgap65", "../h10_nu5_b45-Mt3-768x768-case4-stockholm-MHDgap85", "../h10_nu5_b45-Mt3-768x768-case4-stockholm"],
...
def make_plot(frame, show = False):
    ...
    result,  = plot.plot(x, y, linewidth = linewidth, c = "lightcoral", alpha = 0.9, zorder = 199, label = r"$r_\mathrm{gap,in}=0.45$")
    ...
    if not args.log:
        ...
        plot.scatter([planet_location], [1.005 * 3*10**(-3)], c = 'k', s = 75, alpha = 0.8, clip_on = False)
    ...
    if args.compare is not None:
        labels = [r"$r_\mathrm{gap,in}=0.65$", r"$r_\mathrm{gap,in}=0.85$", "Fiducial"]
        colors = ["peru", "lightskyblue", "b"]
