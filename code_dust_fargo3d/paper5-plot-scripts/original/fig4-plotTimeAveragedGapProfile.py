...
def make_plot(frame, show = False):
    ...
    result,  = plot.plot(x, y, linewidth = linewidth, c = "b", zorder = 199, label = "FOUR-component (New)")
    ...
    if args.compare is not None:
        ...
        for i, directory in enumerate(directories):
            ...
            result = plot.plot(x, y_compare, c = "deepskyblue", linewidth = linewidth, alpha = 0.9, zorder = 99, label = "FOUR-component wind")
