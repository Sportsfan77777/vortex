...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    parser.add_argument('--compare', dest = "compare", nargs = '+', default = ["../h10_nu5_b0-Mt3-768x768-case4-stockholm-migrating", "../h10_nu9_b45-Mt3-768x768-case4-stockholm-migrating", "../h10_nu5_b45-Mt3-768x768-case4-stockholm-migrating-no-extra-gap-torque", "../h10_nu5_b45-Mt3-768x768-case12-stockholm-migrating", "../h10_nu9_b45-Mt3-768x768-case12-stockholm-migrating", "../h10_nu9_b0-Mt3-768x768-case4-stockholm-migrating"],
...
def make_plot(show = False):
    ...
    colors = ["k", "C2", "lime", "indigo", "C4", "grey"]
