...
def make_plot(frame, show = False):
    ...
    result,  = plot.plot(x, y, linewidth = linewidth, c = "deepskyblue", zorder = 199, label = "FOUR-component wind")
    ...
    if args.compare is not None:
        ...
        for i, directory in enumerate(directories):
            ...
            result = plot.plot(x, y_compare, c = "blueviolet", linewidth = linewidth, alpha = 0.9, zorder = 99, label = "Three-component wind")
