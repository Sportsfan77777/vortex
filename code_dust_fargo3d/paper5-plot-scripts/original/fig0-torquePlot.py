...
def make_plot(show = False):
    ...
    xs1 = [r_p - 2.0 * r_hill, r_p - 2.0 * r_hill]
    xs2 = [r_p + 2.0 * r_hill, r_p + 2.0 * r_hill]
    plot.plot(xs1, ys, c = 'grey', linewidth = 1, linestyle = '--', alpha = 0.35)
    plot.plot(xs2, ys, c = 'grey', linewidth = 1, linestyle = '--', alpha = 0.35)
