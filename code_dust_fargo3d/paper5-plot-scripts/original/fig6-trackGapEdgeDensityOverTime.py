...
def make_plot(show = False):
    ...
    result1 = plot.plot(x, y, c = 'b', linewidth = linewidth, zorder = 199, label = "FOUR-component (New)")
    ...
    if args.compare is not None:
        ...
        alphas = [1.0, 0.4, 0.4]
        labels = ["Two-component", "Three-component", "FOUR-component"]
        linewidths = [0, -2, -2]
    ...
    plot.legend(loc = "upper right", fontsize = fontsize - 5)
