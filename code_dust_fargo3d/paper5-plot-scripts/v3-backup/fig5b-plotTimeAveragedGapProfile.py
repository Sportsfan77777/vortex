...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    parser.add_argument('--compare', dest = "compare", nargs = '+', default = ["/tiara/home/mhammer/storage/kawas/h10_nu5_b45-Mt3-768x768-case12-stockholm"],
...
def make_plot(frame, show = False):
    ...
    result,  = plot.plot(x, y, linewidth = linewidth, c = "deepskyblue", zorder = 199, label = "Four-component")
    ...
    if args.compare is not None:
        ...
        for i, directory in enumerate(directories):
            ...
            result = plot.plot(x, y_compare, c = "slateblue", linewidth = linewidth, alpha = 0.9, zorder = 99, label = "Three-component")
