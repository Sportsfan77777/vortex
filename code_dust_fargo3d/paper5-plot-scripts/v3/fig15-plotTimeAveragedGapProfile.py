...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    parser.add_argument('--compare', dest = "compare", nargs = '+', default = ["../h10_nu5_b45-Mt3-768x768-case4-stockholm", "../h10_nu6_b45-Mt3-768x768-case4-stockholm", "../h10_nu7_b45-Mt3-768x768-case4-stockholm"],
...
def make_plot(frame, show = False):
    ...
    result,  = plot.plot(x, y, linewidth = linewidth, c = "gold", alpha = 0.9, zorder = 199, label = r"$\nu = 10^{-4}$")
    ...
    if args.compare is not None:
        labels = [r"$\nu = 10^{-5}$ (fiducial)", r"$\nu = 10^{-6}$", r"$\nu = 10^{-7}$", r"$\nu = 10^{-9}$"]
        colors = ["b", "yellowgreen", "darkolivegreen", "orangered"]
