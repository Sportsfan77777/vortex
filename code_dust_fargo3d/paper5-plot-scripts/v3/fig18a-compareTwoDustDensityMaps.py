...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Frame Selection
    parser.add_argument('--frames', type = int, nargs = 2, default = [140, 140],
                         help = 'select two frames')
    parser.add_argument('-d', dest = "compare_directory", default = "../h05_alpha3_b45-M03-768x768-case4-stockholm",
    ...
    parser.add_argument('--range', dest = "r_lim", type = float, nargs = 2, default = [0.9, 1.5],
