...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    parser.add_argument('--compare', dest = "compare", nargs = '+', default = ["/tiara/home/mhammer/scratch/h10_nu9_b45-Mt3-768x768-case4-stockholm-no-extra-gap-torque"],
...
def make_plot(frame, show = False):
    ...
    result,  = plot.plot(x, y, linewidth = linewidth, c = "r", zorder = 99, label = "This work")
    ...
    if args.compare is not None:
        ...
        for i, directory in enumerate(directories):
            ...
            result = plot.plot(x, y_compare, linewidth = linewidth, c = "firebrick", alpha = 0.6, zorder = 99, label = labels[i])
    ...
    text_comp = "Two-component"
    text_comps = "(Torque & Mass Loss)"
    plot.text(0.95 * x_range + x_min, 0.9 * plot.ylim()[-1], text_comp, fontsize = fontsize, color = 'black', horizontalalignment = 'right')
    plot.text(0.95 * x_range + x_min, 0.84 * plot.ylim()[-1], text_comps, fontsize = fontsize - 6, color = 'black', horizontalalignment = 'right')
