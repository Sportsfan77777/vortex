...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    parser.add_argument('--compare', dest = "compare", nargs = '+', default = ["../h05_nu5_b3-M03-768x768-case4-stockholm-migrating-copy", "../h05_nu5_b3-M03-768x768-case4-stockholm-migrating-no-extra-gap-torque-simple-mass-loss", "../h05_nu5_b3-M03-768x768-case12-stockholm-migrating-copy"],
...
def make_plot(show = False):
    ...
    plot.text(0.05 * x_range + x_min, 0.82 * plot.ylim()[-1], text_nu, fontsize = fontsize, color = 'black', horizontalalignment = 'left')
