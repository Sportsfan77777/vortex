...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    parser.add_argument('--range', dest = "r_lim", type = float, nargs = 2, default = [0.3, 3.0],
                         help = 'radial range in plot (default: [r_min, r_max])')
    parser.add_argument('--max_y', dest = "max_y", type = float, default = 2.0,
    ...
    parser.add_argument('--compare', dest = "compare", nargs = '+', default = ["../h10_nu5_b45-Mt3-768x768-case4-stockholm-3000-orbits-to-r585-simple-mass-loss", "../h10_nu5_b65-Mt3-768x768-case4-stockholm-3000-orbits-to-r585-no-mass-loss", "/tiara/home/mhammer/scratch/h10_nu5_b45-Mt3-768x768-case4-stockholm-3000-orbits-to-r585-no-extra-gap-torque", "/tiara/home/mhammer/scratch/h10_nu5_b45-Mt3-768x768-case4-stockholm-3000-orbits-to-r585-simple-mass-loss-no-extra-gap-torque"],
...
def make_plot(frame, show = False):
    ...
    result,  = plot.plot(x, y, linewidth = linewidth, c = "b", zorder = 199, label = "Four-component")
    ...
    if args.compare is not None:
        ...
        for i, directory in enumerate(directories):
            ...
            result = plot.plot(x, y_compare, linewidth = linewidth, c = colors[i], alpha = 0.6, zorder = 99, label = labels[i])
    ...
    for i, case_i in enumerate(cases):
       ...
       yref = ref_density[:, 1]
       #plot.plot(xref, yref, linewidth = linewidth, linestyle = "-.", c = colors[i % 2], zorder = 2, label = "Inviscid")
    ...
    plot.legend(loc = "upper right", handlelength = 2.3, fontsize = fontsize - 6)
    ...
    ax.set_ylabel(r"$\Sigma$ $/$ $\Sigma_\mathrm{p}$", fontsize = fontsize)
    ...
    plot.text(0.02 * x_range + x_min, 0.9 * (plot.ylim()[-1] - plot.ylim()[0]) + plot.ylim()[0], text_nu, fontsize = fontsize, color = 'black', horizontalalignment = 'left')
