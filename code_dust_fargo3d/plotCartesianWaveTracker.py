...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "waveTracker",
                         help = 'save directory (default: waveTracker)')
...
def getWaveLocations(density, start_radius = 1.05, end_radius = 1.30):
    ...
    radii = rad[start_i : end_i] # truncate to selected range
