...
pickle.dump(np.array(frame_range), open("gas_variance_frames.p", "wb"))
pickle.dump(np.array(mass_over_time), open("gas_variance_values.p", "wb"))
...
def make_plot(show = False):
    ...
    if args.data:
        frame_range_data = pickle.load(open("%s/gas_variance_frames.p" % args.data, "rb"))
        mass_over_time_data = pickle.load(open("%s/gas_variance_frames.p" % args.data, "rb"))
    ...
    plot.ylabel("Gas Variation", fontsize = fontsize)
