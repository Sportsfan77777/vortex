...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "waveAction",
                         help = 'save directory (default: waveAction)')
...
def make_plot(frame, show = False):
    ...
    # Reference
    vortex_rad, _ = az.get_radial_peak(np.average(density, axis = 1), fargo_par, end = 2.0)
    ...
    if version is None:
        ...
        save_fn = "%s/v%04d_waveAction_%04d.png" % (save_directory, version, frame)
