...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "azimuthalDustProfiles",
                         help = 'save directory (default: gasDensityMaps)')
    parser.add_argument('-n', dest = "num_dust", type = int, default = 3,
                         help = 'number of dust fluids (default: 3)')
    ...
    parser.add_argument('--range', dest = "theta_lim", type = float, nargs = 2, default = None,
                         help = 'theta range in plot (default: [0, 360])')
    parser.add_argument('--max_y', dest = "max_y", type = float, default = None,
                         help = 'maximum density (default: 1.1 times the max)')

    parser.add_argument('--raw', dest = "normalize", action = 'store_false', default = True,
                         help = 'normalize or raw (default: normalize)')
...
def make_plot(frame, show = False):
    ...
    if version is None:
        ...
        save_fn = "%s/v%04d_azimuthalDustProfiles_%04d.png" % (save_directory, version, frame)
