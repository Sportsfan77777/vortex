...
master_frame_ranges[671] = [[75, 3000, 25], [100, 3000, 25], [300, 7000, 25], [600, 8500, 25], [400, 4000, 25], [100, 3000, 25]]
...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    parser.add_argument('--dir', dest = "save_directory", default = "rossbyGapDepth",
...
def find_rossby_density(averaged_density, averaged_vorticity):
    ...
    rossby_min_density = averaged_density[inner_max_diff_i] # Density at location with the steepest gradient in the maximum condition (c_s^2 * density / vorticity)
...
def make_plot(show = False):
    ...
    # Save, Show, and Close
    if version is None:
        save_fn = "%s/rossbyGapDepth_choice%d.png" % (save_directory, args.choice)
    else:
        save_fn = "%s/v%04d_rossbyGapDepth_choice%d.png" % (save_directory, version, arg.choice)
