...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "averagedMultiDustDensity%d",
    ...
    parser.add_argument('--y2_range', dest = "y2_range", type = float, nargs = 2, default = [1e-5, 4e3],
...
def make_plot(frame, show = False):
    ...
    # Save, Show, and Close
    if version is None:
        save_fn = "%s/averagedMultiDustDensity%d_%04d.png" % (save_directory, dust_number, frame)
    else:
        save_fn = "%s/v%04d_averagedMultiDustDensity%d_%04d.png" % (save_directory, version, dust_number, frame)
