...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "averagedStress",
                         help = 'save directory (default: averagedStress)')
...
def make_plot(frame, show = False):
    ...
    if version is None:
        ...
        save_fn = "%s/v%04d_averagedStress_%04d.png" % (save_directory, version, frame)
