...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "averagedVorticityJump",
                         help = 'save directory (default: averagedVorticityJump)')
...
def make_plot(frame, show = False):
    ...
    vorticity = utilVorticity.velocity_curl(vrad, vtheta, rad, theta, rossby = False, residual = False)
    ...
    if version is None:
        ...
        save_fn = "%s/v%04d_averagedVorticityJump%04d.png" % (save_directory, version, frame)
