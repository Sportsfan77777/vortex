...
def make_plot(show = False):
    ...
    if version is None:
        save_fn = "%s/%s_contrastsOverTime.png" % (save_directory, directory_name)
    else:
        save_fn = "%s/v%04d_%s_contrastsOverTime.png" % (save_directory, version, directory_name)
