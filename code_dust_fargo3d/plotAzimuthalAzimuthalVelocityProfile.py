...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "azimuthalVelocityProfiles",
                         help = 'save directory (default: azimuthalVelocityProfiles)')
...
def shift_density(normalized_density, azimuthal_velocity, fargo_par, option = "away", reference_density = None, frame = None):
    ...
    shifted_azimuthal_veloctiy = np.roll(azimuthal_velocity, shift_c, axis = -1)
