...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    parser.add_argument('--y_range', dest = "y_range", type = float, nargs = 2, default = [-0.5, 0.5],
...
def make_plot(frame, show = False):
    ...
    plot.text(x_mid, y_text * (plot.ylim()[-1] - plot.ylim()[0]), title1, horizontalalignment = 'center', bbox = dict(facecolor = 'none', edgecolor = 'black', linewidth = 1.5, pad = 7.0), fontsize = fontsize + 2)
