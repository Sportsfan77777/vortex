...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "averagedVortensitySeries",
                         help = 'save directory (default: averagedVortensitySeries)')
...
def make_plot(frame_range, show = False):
    ...
    if version is None:
        save_fn = "%s/averagedVortensity_%s_%04d-%04d-%04d.png" % (save_directory, directory_name, args.frames[0], args.frames[1], args.frames[2])
    else:
        save_fn = "%s/v%04d_averagedVortensity_%s_%04d-%04d-%04d.png" % (save_directory, version, directory_name, args.frames[0], args.frames[1], args.frames[2])
