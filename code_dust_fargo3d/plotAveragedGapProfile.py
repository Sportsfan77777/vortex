...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "averagedGapProfile",
                         help = 'save directory (default: averagedGapProfile)')
...
def make_plot(frame, show = False):
    ...
    # Save, Show, and Close
    if version is None:
        save_fn = "%s/averagedGapProfile_%04d.png" % (save_directory, frame)
    else:
        save_fn = "%s/v%04d_averagedGapProfile_%04d.png" % (save_directory, version, frame)
