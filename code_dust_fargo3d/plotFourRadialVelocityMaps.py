...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "fourRadialVelocityMaps",
                         help = 'save directory (default: fourRadialVelocityMaps)')
...
def make_plot(frames, show = False):
    ...
    # Save, Show, and Close
    if version is None:
        save_fn = "%s/radialVelocityMap_%04d-%04d-%04d-%04d.png" % (save_directory, frames[0], frames[1], frames[2], frames[3])
    else:
        save_fn = "%s/v%04d_radialVelocityMap_%04d-%04d-%04d-%04d.png" % (save_directory, version, frames[0], frames[1], frames[2], frames[3])
