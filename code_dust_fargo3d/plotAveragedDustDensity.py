...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "averagedDustDensity%d",
...
def make_plot(frame, show = False):
    ...
    # Save, Show, and Close
    if version is None:
        save_fn = "%s/averagedDustDensity%d_%04d.png" % (save_directory, dust_number, frame)
    else:
        save_fn = "%s/v%04d_averagedDustDensity%d_%04d.png" % (save_directory, version, dust_number, frame)
